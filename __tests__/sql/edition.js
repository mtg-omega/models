  ...
  describe('Edition', () => {
    describe('Model', () => {
      it('should be a model', () => {
        ...
        expect(Edition._timestampAttributes.createdAt).toBe('createdAt'); // eslint-disable-line no-underscore-dangle
        expect(Edition._timestampAttributes.updatedAt).toBe('updatedAt'); // eslint-disable-line no-underscore-dangle
      ...
      it('should be an international model', () => {
        ...
        expect(EditionI18N._timestampAttributes.createdAt).toBe('createdAt'); // eslint-disable-line no-underscore-dangle
        expect(EditionI18N._timestampAttributes.updatedAt).toBe('updatedAt'); // eslint-disable-line no-underscore-dangle
