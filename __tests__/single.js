import { sequelize, Single, SingleI18N, Edition } from '../src';
  ...
  describe('Single', () => {
    describe('Model', () => {
      it('should be a model', () => {
        ...
        // eslint-disable-next-line no-underscore-dangle
        expect(Single._timestampAttributes.createdAt).toBe('createdAt');
        // eslint-disable-next-line no-underscore-dangle
        expect(Single._timestampAttributes.updatedAt).toBe('updatedAt');
      ...
      it('should be an international model', () => {
        ...
        // eslint-disable-next-line no-underscore-dangle
        expect(SingleI18N._timestampAttributes.createdAt).toBe('createdAt');
        // eslint-disable-next-line no-underscore-dangle
        expect(SingleI18N._timestampAttributes.updatedAt).toBe('updatedAt');
